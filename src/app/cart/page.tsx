...
export default function Cart() {
  return (
    <div className="container mx-auto px-4 md:px-6 h-screen bg-gradient-to-r from-black via-gray-500 to-black ">
      <h2 className="text-2xl md:text-3xl font-bold mb-8  font-medium">Your Cart</h2>
      <div className=" rounded-lg  p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="bg-gray-100 rounded-lg p-4">
            ...
            <p className="text-black font-medium bold mb-4">$24.99</p>
          ...
          <div className="bg-gray-100 rounded-lg p-4">
            ...
            <p className="text-black bold font-medium mb-4">$39.99</p>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Button size="sm" variant="cart">
                  -
          ...
          <div className="bg-gray-100 rounded-lg p-4">
            ...
            <p className=" mb-4  font-medium text-black bold">$14.99</p>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Button size="sm" variant="cart">
                  -
